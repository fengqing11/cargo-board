...
function App() {
  ...
  function handleTableScroll(event: React.UIEvent<HTMLDivElement>) {
    ...
    if (distanceToBottom <= SCROLL_BOTTOM_THRESHOLD_PX && safeCurrentPage < totalPages) {
